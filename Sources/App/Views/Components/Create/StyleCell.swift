...
class StyleCell: UICollectionViewCell {
    ...
    func setupConstrains() {
        ...
        iconPremium.snp.makeConstraints {
            $0.trailing.equalTo(styleThumbView.snp.trailing).inset(15.scaleX)
            $0.top.equalTo(styleThumbView.snp.top).inset(15.scaleX)
    ...
    func setData(style: StyleConfigModel) {
        ...
        iconPremium.isHidden = !style.isPremium 
        
    }
    
    override var isSelected: Bool {
        didSet {
            styleThumbView.layer.borderWidth = isSelected ? 2.scaleX : 0
            styleThumbImageView.snp.updateConstraints {
                $0.edges.equalToSuperview().inset(isSelected ? 6.scaleX : 0)
            }
